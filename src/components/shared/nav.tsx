...
import { Dumbbell, Users, CreditCard, LogIn, Settings, BarChart3, Cpu, Lock, ScrollText, Activity } from "lucide-react";
...
export function Nav({ role }: NavProps) {
  ...
  const adminLinks = [
    ...
    { href: "/admin/statistika", label: "Statistika", icon: Activity },
